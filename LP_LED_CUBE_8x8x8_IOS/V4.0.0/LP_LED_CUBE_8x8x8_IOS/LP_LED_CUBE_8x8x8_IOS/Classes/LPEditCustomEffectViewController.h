//
//  LPEditCustomEffectViewController.h
...
@interface LPEditCustomEffectViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UITextFieldDelegate, UIActionSheetDelegate>
