//
//  LPNewCustomEffectViewController.m
...
@interface LPNewCustomEffectViewController ()
...
@implementation LPNewCustomEffectViewController
...
- (void)viewDidLoad
{
    ...
    self.title = [[[LPSharedManager sharedManager] languageDictionary] objectForKey:@"NewCustomEffectViewTitle"];
...
- (void)saveButtonClicked
{
    if (self.nameTextField.text.length > 0) {
        ...
        self.effect.view = self.selectedView;
