...
@interface LPNewEffectViewController ()
...
@implementation LPNewEffectViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Add" style:UIBarButtonItemStyleBordered target:self action:@selector(rightBarButtonClicked:)];
...
- (LPCubeEffect *)cubeEffect
{
    if (!_cubeEffect) {
        _cubeEffect = [LPCubeEffect new];
    }
    return _cubeEffect;
}
